...
func (sq *ShowQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (sq *ShowQuery) FirstIDX(ctx context.Context) int {
...
func (sq *ShowQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (sq *ShowQuery) OnlyIDX(ctx context.Context) int {
...
func (sq *ShowQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (sq *ShowQuery) IDsX(ctx context.Context) []int {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (sq *ShowQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(show.Table, show.Columns, sqlgraph.NewFieldSpec(show.FieldID, field.TypeInt))
	_spec.From = sq.sql
...
func (sq *ShowQuery) ForUpdate(opts ...sql.LockOption) *ShowQuery {
...
func (sq *ShowQuery) ForShare(opts ...sql.LockOption) *ShowQuery {
	if sq.driver.Dialect() == dialect.Postgres {
		sq.Unique(false)
	}
	sq.modifiers = append(sq.modifiers, func(s *sql.Selector) {
